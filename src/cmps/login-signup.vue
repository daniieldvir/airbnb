    ...
    <main class="login-signup">
      ...
      <section v-if="!isSignedUp" class="sign-log-forms">
        <form @submit.prevent="signup">
          <label for="">Full Name:<input type="text" v-model="signupInfo.fullname"></label>
          <label for="">Email: <input type="email" v-model="signupInfo.email"></label>
          <label for="">Username:<input type="text" v-model="signupInfo.username"></label>
          <label for="">Password:<input type="password" v-model="signupInfo.password"></label>
      ...
      <section v-if="isSignedUp" class="sign-log-forms">
        ...
        <label for="">Username:<input type="text" place="Enter your username" v-model="loginInfo.username"></label>
        <label for="">Password:<input type="password" place="Enter your password" v-model="loginInfo.password"></label>
          <button>Login</button>
