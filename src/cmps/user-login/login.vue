  ...
  <section class="login-modal" @click.stop>
    ...
    <div class="login-input">
      <form action="" @submit.prevent="login">
        <input type="text" placeholder="Enter username" v-model="userCred.username" ref="usernameInputRef"/>
  ...
  methods: {
    async login() {
      try {
        ...
        if(!this.userCred.username || !this.userCred.password) return this.msg = 'Please enter username/password';
